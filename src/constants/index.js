...
export const HERO_CONTENT = `I'm Avinash, a passionate and skilled fullstack developer specializing in Python. With a strong foundation in both frontend and backend technologies, I've gained expertise in HTML, CSS, JavaScript, Bootstrap, and React on the frontend, along with Python, Django, and PostgreSQL on the backend. I enjoy building efficient, user-friendly applications and am always eager to explore new technologies and take on challenging projects.`;

export const ABOUT_TEXT = `I am a dedicated and versatile full stack developer with a passion for building efficient, user-friendly web applications. Although I'm just beginning my professional journey, I have a solid foundation in full stack development, having worked with HTML, CSS, JavaScript, Bootstrap, and React on the frontend, as well as Python, Django, and PostgreSQL on the backend. My journey into web development was sparked by a deep curiosity about how things work, which has grown into a commitment to learning and tackling new challenges. I thrive in collaborative environments and enjoy problem-solving to deliver high-quality solutions. Outside of coding, I stay active, explore new technologies, and aim to contribute to open-source projects in the near future.`;
